                    ...
                    <TextBlock
                      ...
                      subtext={<div>
                        <ul className="list-disc list-outside pl-5">
                          ...
                          <li className="mb-3">Our model trains for generalization before specialization which makes it much more robust to the vagaries of the real world (in fact, this is how infants learn! 🍼)</li>
                    ...
                    <TextBlock
                      ...
                      subtext={<div>
                        <ul className="list-disc list-outside pl-5">
                          ...
                          <li className="mb-3">This makes our model scale much better - and scaling is key to building a successful production-level system</li>
                        </ul>
                        <div className="mt-5">
